...
class CartItemModelTest(TestCase):
    def setUp(self):
        ...
        self.product = Product.objects.create(name="Prod", category=cat, price=20, stock_quantity=10)
...
class ShopViewsTest(TestCase):
    ...
    def test_add_to_cart_requires_login(self):
        ...
        response = self.client.post(reverse("add_to_cart"), {}, HTTP_X_REQUESTED_WITH="XMLHttpRequest")
    ...
    def test_add_to_cart_logged_in(self):
        ...
        response = self.client.post(
            reverse("add_to_cart"),
            data=json.dumps({"product_id": self.product.id}), # Converted to JSON payload
